...
Let $\P\in\mathcal{M}(\mathbb{R}^d)$ and $R>0$. The $1$-Wasserstein distance between $\P$ and $\mathcal{P}_{R}\# \P$ is controlled as follows:
...
\begin{proof}[of \Cref{l: quasi_lpz_quad}]
...
For any $\lambda, \varepsilon_m$ defined as in \Cref{l: quasi_lpz_quad}, any $\delta>0$, we have with probability $1-2\delta$ over the sample $\Sm$, for any $\P\in\mathcal{P}_1(\mathcal{H})$:
...
\begin{proof}[of \Cref{l: gaussian_tail}]
...
\begin{proof}[of \Cref{th: main_gaussian_smooth}]
