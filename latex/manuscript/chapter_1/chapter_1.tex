...
To conclude this introduction we recap in \Cref{fig: recap} the classical information-theoretic vision of PAC-Bayes alongside the original optimisation view proposed above. 

\begin{figure}[!h]
  \centering
  \includegraphics[width=1.0\linewidth]{chapter_1/recap-intro.pdf}
  \caption{Comparison with the two vision of PAC-Bayes described above. }
  \label{fig: recap}
\end{figure}
